  ...
  return (
    <div aria-hidden="true" className="relative size-full">
      ...
      <div className="absolute inset-0">
        <Marker src="/map/letter-a.png" top={96} offset={-128} delay={0.15} />
        <Marker src="/map/letter-b.png" top={160} offset={-16} delay={0.4} />
        <Marker src="/map/letter-c.png" top={144} offset={96} delay={0.3} />
        <Marker src="/map/letter-d.png" top={192} offset={64} delay={0.6} />
        <Marker src="/map/letter-e.png" top={224} offset={-32} delay={0.8} />
      </div>
    </div>
  )
}
